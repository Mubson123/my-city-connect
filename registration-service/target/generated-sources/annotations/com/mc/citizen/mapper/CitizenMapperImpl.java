...
public class CitizenMapperImpl implements CitizenMapper {
    ...
    public CitizenResponseDto toResponseDto(Citizen citizen) {
        ...
        Set<Phone> set1 = citizen.getPhones();
        if ( set1 != null ) {
            citizenResponseDto.phones( new LinkedHashSet<Phone>( set1 ) );
        }
    ...
    public Citizen toEntity(CitizenRequestDto citizenRequestDto) {
        ...
        Set<Phone> set1 = citizenRequestDto.phones();
        if ( set1 != null ) {
            citizen.phones( new LinkedHashSet<Phone>( set1 ) );
        }
